...
>>[!Proof]-
>>(Existencia)
>>1. Dado $v\in V$ escribimos $g(v)=g_{\mathbb{R}}(v)+ig_{I}(v)$ con $g_{\mathbb{R}},g_{I}$ funcionales lineales (ejercicio) (esto vendría a ser como la parte imaginaria y la parte real)
